...
export const colors: GlobalPalette = {
  ...
  blue200: '#ADBCFF',
  blue300: '#869EFF',
  blue400: 'linear-gradient(90deg, #6D00F3 0%, #FF0052 105.14%)',
  blue500: 'linear-gradient(90deg, #6D00F3 0%, #FF0052 105.14%)',
  blue600: '#4C8000',
  blue700: '#09265E',
  blue800: '#0B193F',
  blue900: '#040E34',
  ...
  networkArbitrum: 'linear-gradient(90deg, #6D00F3 0%, #FF0052 105.14%)',
